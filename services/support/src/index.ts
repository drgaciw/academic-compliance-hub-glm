...
app.get('/students/:id/sessions', (c) => {
  ...
  return c.json(successResponse({
    studentId,
    sessions: [
      { id: '1', subject: 'Math', date: '2024-01-15', duration: 60, status: 'COMPLETED' },
      { id: '2', subject: 'Physics', date: '2024-01-20', duration: 60, status: 'SCHEDULED' },
    ],
  }));
});

// Create tutoring session
app.post('/students/:id/sessions', zValidator('json', z.object({
  subject: z.string(),
  date: z.string(),
  duration: z.number(),
